...
![alt text](iterative_process.gif)
...
{{< figure src="rotated_prob.png" caption="Initial positions of the robots and a rotated target formation.">}}
{{< figure src="SOAGF_rot_Sol.png" caption="Soution generated without variable rotation.">}}
{{< figure src="rotated_prob_sol1.png" caption="Solution generated from the iterative approach with variable rotation.">}}
{{< figure src="SOAGF_normal_sol.gif" caption="Trajectories generated without variable rotation.">}}
{{< figure src="SOAGF_iter_sol.gif" caption="Trajectories generated from the iterative approach with variable rotation.">}}
